...
try:
    ...
    for city_num,cities in iterating_location_dict.items():
        ...
        # Iterating through categories in the city
            for categorie in category_list:
                ...
                while True:
                    ...
                    for item in mark_html:
                        ...
                        if (number not in existing_numbers) and number != '_No number provided_':
                            ...
                            if link != '_More info not found_':
                                ...
                                try:
                                    social_links = []            
                                    social_blocks = new_soup.find('dd', class_= 'social-links')
                                    if social_blocks:
                                        for block in social_blocks:
                                            social = block.find('a')
                                            social_link = social['html']
                                            social_links.append({f'Social Link': {social_link}})
                                    social_links.append('_No Social Links Found')
                                except Exception as e:
                                    print(f'_Exception: {str(e)}_')
                    ...
                    print(f'Processed page {counter} of {categorie} in {city}, with a total of {business_counter} businesses added.')
